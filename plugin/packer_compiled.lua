...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/abeldlp/.local/share/nvim/site/pack/packer/start/coc.nvim",
    url = "https://github.com/neoclide/coc.nvim"
  },
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/abeldlp/.local/share/nvim/site/pack/packer/start/completion-nvim",
  ...
  vimspector = {
    loaded = true,
    path = "/home/abeldlp/.local/share/nvim/site/pack/packer/start/vimspector",

...
-- Telescope
vim.api.nvim_set_hl(0, "TelescopeNormal", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopeBorder", { bg = "#1e2030" })

vim.api.nvim_set_hl(0, "TelescopePromptNormal", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopePromptTitle", { bg = "#1e2030", fg = "#8CAAEE" })
vim.api.nvim_set_hl(0, "TelescopePromptBorder", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopePromptPrefix", { bg = "#1e2030", fg = "#8CAAEE" })

vim.api.nvim_set_hl(0, "TelescopeResultsNormal", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopeResultsTitle", { bg = "#1e2030", fg = "#8CAAEE" })
vim.api.nvim_set_hl(0, "TelescopeResultsBorder", { bg = "#1e2030" })

vim.api.nvim_set_hl(0, "TelescopePreviewNormal", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopePreviewBorder", { bg = "#1e2030", fg = "#8CAAEE" })
vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { bg = "#1e2030" })
vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { bg = "#1e2030" })
